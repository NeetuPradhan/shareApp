...
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <form role="form" method="post" action="<?=base_url().'backend/company_type/edit'.'/'.$info['id']?>">
        ...
        <div class="col-lg-6">
            <div class="form-group <?php if(form_error('type')) echo 'has-error' ?>">
                ...
                <input name="type" placeholder="Type" class="form-control" value="<?=set_value('type',$info['type']);?>">
                <?=form_error('type')?>
            </div>
