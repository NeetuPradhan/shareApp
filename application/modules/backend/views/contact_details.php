    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="row">
                    <form role="form" id="frm" method="post" action="<?=base_url().'backend/settings/contact_details'?>">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="time" id="fax" name="weekend_start_time" placeholder="hrs:mins" pattern="^([0-1]?[0-9]|2[0-3]):([0-5][0-9])(:[0-5][0-9])?$" value="<?=set_value('weekend_start_time',$info['weekend_start_time']);?>" > &nbsp;-&nbsp; 
                                <input type="time" id="fax" name="weekend_end_time" placeholder="hrs:mins" pattern="^([0-1]?[0-9]|2[0-3]):([0-5][0-9])(:[0-5][0-9])?$" value="<?=set_value('weekend_end_time',$info['weekend_end_time']);?>" >   
                            </div>
                        </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAmZW6nhwlAXb9kwV6_nq7cRRkDaJEVUVE" type="text/javascript"></script>
...
<script type="text/javascript">
    var geocoder = new google.maps.Geocoder(),
        ...
        lat = <?php if ($info["lat"] != 0)echo $info["lat"]; else echo 27.7038;?>,
        lon = <?php if ($info["lon"] != 0)echo $info["lon"]; else echo 85.3232;?>;
