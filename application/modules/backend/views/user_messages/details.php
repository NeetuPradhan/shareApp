...
<script type="text/javascript">
    ...
    $(document).ready(function(){
      $('#email_form').on('submit', function (e) {
            ...
            $.ajax({
                type: 'post',
                url: "<?=base_url().'backend/messages/reply'?>",
                data: values,
                dataType: 'json',
                beforeSend: function(){
                ...
                success: function (data) {
                    ...
                    if(data['status']=='success') {
                      ...
                      alert(data['message']);
                            ...
                            "</button>" + 
                            data['message'] + 
                            " Click <a target='_blank' href='" + adminURL + "error_log'>here</a> to view the error log." +
                            "</div>";
                            $("#modal_body").prepend(responseHTML);
                ...
                error:function(data) {
                    ...
                    var responseHTML = "<div role='alert' class='alert alert-danger fade in' id='alert'>" + 
                            ...
                            "</button>" + 
                            "Unknown Error. " + 
                            "Please try again later. Click <a target='_blank' href='" + adminURL + "error_log'>here</a> to view the error log." 
                            "</div>";
