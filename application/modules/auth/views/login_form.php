                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            ...
                            <label class="checkbox1"><input type="checkbox" name="remember_me" checked=""><i> </i>Remember Me</label></br>
                                ...
                                <a title="Forgot password" href="<?php echo getAuthUrl().'/login/forgot_pass'?>">forgot password?</a>
                            </div>
            ...
            <div class="row">
                <div class="col-xs-12">
                    <div class="panel panel-default">    
                        ...
                        <div class="panel-body">                            
                            <a id="lbtnSignup" class="btn btn-primary" title="Create Free Account" href="<?php echo getRegisterUrl().'member';?>">Create Free Account</a>
                        </div>
