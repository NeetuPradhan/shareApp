<div class="container">
    <div class="row">
        <div class="col-lg-12">
            <h4 class="page-header"><span>Create Free Account</span></h4>
        </div>
    </div>
    <div>
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-6 col-md-5 col-lg-4">
                                            <textarea name="address" rows="2" cols="20" value="<?= set_value('address') ?>" title="Address" placeholder="Address" class="form-control"></textarea>
                                            <?= form_error('address') ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4 col-md-3 col-lg-3">
                                            <input name="city" type="text" id="city"  title="City" placeholder="City" class="form-control" />
                                            <?= form_error('city') ?>
                                        </div>
                                    </div>
                                </div>
