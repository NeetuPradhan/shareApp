<div class="container">
    ...
    <div>
        <form role="form"  method="post" action="<?=getCompanyUrl().'announcement_edit/'.$info['id']?>">
                            ...
                            <div class="form-horizontal">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4 col-md-3 col-lg-3">
                                        <input name="title" type="text" value="<?= set_value('title',$info['title']) ?>" title="Title" placeholder="Title" class="form-control" />                
                                        <?= form_error('title') ?>
                                    </div>
                                </div>
                                <div class="form-group">
